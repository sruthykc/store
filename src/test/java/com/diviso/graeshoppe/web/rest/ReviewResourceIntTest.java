...
public class ReviewResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_REVIEWED_DATE = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_REVIEWED_DATE = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public void createReview() throws Exception {
        ...
        assertThat(testReview.getReviewedDate()).isEqualTo(DEFAULT_REVIEWED_DATE);
    }
    ...
    public void getAllReviews() throws Exception {
        ...
        restReviewMockMvc.perform(get("/api/reviews?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].reviewedDate").value(hasItem(sameInstant(DEFAULT_REVIEWED_DATE))));
    }
    ...
    public void getReview() throws Exception {
        ...
        restReviewMockMvc.perform(get("/api/reviews/{id}", review.getId()))
            ...
            .andExpect(jsonPath("$.reviewedDate").value(sameInstant(DEFAULT_REVIEWED_DATE)));
    }
    ...
    public void updateReview() throws Exception {
        ...
        assertThat(testReview.getReviewedDate()).isEqualTo(UPDATED_REVIEWED_DATE);
    }
