...
public class ReplyResource {
    ...
    private static final String ENTITY_NAME = "storeReply";
     ...
     */
    @PutMapping("/replies")
    public ResponseEntity<ReplyDTO> updateReply(@Valid @RequestBody ReplyDTO replyDTO) throws URISyntaxException {
