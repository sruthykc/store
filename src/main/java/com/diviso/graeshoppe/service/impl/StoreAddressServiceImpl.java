...
public class StoreAddressServiceImpl implements StoreAddressService {
	...
	public StoreAddressServiceImpl(StoreAddressRepository storeAddressRepository,
	...
	public Page<StoreAddressDTO> findAll(Pageable pageable) {
		...
		return storeAddressRepository.findAll(pageable).map(storeAddressMapper::toDto);
	}
	...
	public Optional<StoreAddressDTO> findOne(Long id) {
		...
		return storeAddressRepository.findById(id).map(storeAddressMapper::toDto);
	}
	...
	public boolean createPublishMesssage(StoreAddressDTO storeAddressDTO, String status) {

		log.debug("Request to publish StoreAddress : {}", storeAddressDTO);

		com.diviso.graeshoppe.store.avro.StoreAddress message = storeAddressAvroMapper.toAvro(storeAddressDTO);
